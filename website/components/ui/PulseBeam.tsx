...
export const PulseBeams = () => {
  return (
    <div className="flex h-[40rem] relative items-center justify-center antialiased  overflow-hidden">
      <button className="bg-slate-800 w-[300px] z-40 h-[100px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
        {/* <span className="absolute inset-0 overflow-hidden rounded-full">
          <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
        </span> */}
        <div className="relative flex justify-center w-[300px] text-center space-x-2 h-[100px]  items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
