    ...
    return (
        <footer className="bg-[#06B6D4] rounded-lg shadow dark:bg-[#06B6D4] m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-300">© 2024 <Link href="https://flowbite.com/" className="hover:underline">Digilabs.Co</Link>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
