  ...
  return (
    <div className="relative overflow-hidden bg-white">
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="absolute  -right-30 w-[50rem] h-[50rem] rounded-full border-2 border-transparent border-t-[2px] border-t-gradient-to-r from-[#06B6D4] to-[#ffffff] opacity-50 animate-spin-reverse" />
      </div>
